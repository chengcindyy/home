...
const about = {
  ...
  // imageSize: 375,
  message:
    "My name is Cindy Cheng. I graduated in 2023 from Douglas College's Emerging Technology program in New Westminster, where I earned a Post-Baccalaureate Diploma in Computer & Information Systems. I am deeply passionate about applying my skills to solve real-world problems. My primary goal is to channel this passion into a career in software development, where I can make meaningful contributions and continue to grow professionally.",
...
const repos = {
  ...
  reposLength: 0,
  specificRepos: ["WeBuy", "BookNManage", "CSIS4175-HMS", "PlatStyle"],
};
